...
switching_list = ['none', 'fix_1000', 'fix_10000', 'adapt']
...
axes = fig.add_gridspec(ncols=3, nrows=3, height_ratios=[1, 8, 8], hspace=0.2)
...
fig.savefig('mujoco_linear.png', bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.close()
